...
var APP = React.createClass({displayName: "APP",
    getInitialState: function () {
        return {directories: [], files: [], dir: localStorage.getItem("dir") || "/"};                 
    },
    ...
    render: function () {
        ...
        return (React.createElement("div", null, 
            ...
            React.createElement("ul", null, this.state.files.map((file, index) => {
                return React.createElement("li", {key: "f"+index}, React.createElement("a", {href: dir=="/" ? "file:///"+file : "file://"+dir+"/"+file}, file));
            }))
        ));
    },
